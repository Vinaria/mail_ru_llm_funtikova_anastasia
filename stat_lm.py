...
def construct_model(model_type: int):
    """
    ...
    stat_lm_path = ['models/stat_lm/stat_lm.pkl', 'models/stat_lm/stat_lm_2.pkl']
    tokenizer_path = ['models/stat_lm/tokenizer.pkl', 'models/stat_lm/tokenizer_2.pkl']

    tokenizer = Tokenizer()
    tokenizer.load(tokenizer_path[model_type])

    stat_lm = StatLM(tokenizer)
    stat_lm.load_stat(stat_lm_path[model_type])
